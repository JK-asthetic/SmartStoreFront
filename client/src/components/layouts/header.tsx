    ...
    <>
      <header className="bg-white shadow fixed w-full z-50">
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center">
              <Link
                href="/"
                className="text-primary font-poppins font-bold text-2xl"
              >
        ...
        <div
          ...
          } md:hidden bg-white w-full border-t border-gray-200`}
        >
      ...
      {/* AuthModal is now conditionally rendered regardless of isLoggedIn state */}
      {!isAuthenticated && (
        <AuthModal
